				...
				<div id="center_center">
					<form action="#" method="post" onsubmit="">
						...
						<div class="form-group row">
							...
							<div class="input-group col-sm-10">
								...
								<div class="input-group-append">
									<input type="button" class="btn btn-danger"	value="중복체크" value=""
										 onclick="checkMid()">
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" id="m_name" name="m_name" value=""
									class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="password" id="m_pw" name="m_pw" value=""
									class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="tel" pattern="(010)\d{3,4}\d{4}" id="m_phone" name="m_phone" value=""
									class="form-control">
							</div>
						</div>
						<div class="form-group row">
