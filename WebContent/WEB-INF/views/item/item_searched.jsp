						...
						<div id="bottom_c">
							...
							<div id="bottom_c_c">
								<nav aria-label="Page navigation example">
									<ul class="pagination">
										<li class="page-item"><a class="page-link" href="item_list_search?ipageNumber=1"> 
											<span aria-hidden="true">&laquo;</span></a>
										</li>
										<c:if test="${igroupNo > 1}">
											<li class="page-item"><a class="page-link" href="item_list_search?ipageNumber=${istartPageNo - 1}"> 
												<span aria-hidden="true"><</span></a>
											</li>
										</c:if>
										<c:forEach begin="${istartPageNo}" end="${iendPageNo}" var="i">
											<c:if test="${ipageNumber == i}">
												<li class="page-item active"><a class="page-link" href="item_list_search?searchedipageNumber=${i}">${i}</a></li>		
											</c:if>
											<c:if test="${ipageNumber != i}">
												<li class="page-item"><a class="page-link" href="item_list_search?searchedipageNumber=${i}">${i}</a></li>
											</c:if>
										</c:forEach>
