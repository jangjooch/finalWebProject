			...
			<div id="center_detail">
				...
				<div id="center_center">
					<form action="#" method="post" onsubmit="">
						...
						<input type="hidden" id="d_num" name="d_num" class="form-control">
						
						<div class="form-group row">
							<label for="d_model" class="col-sm-5 col-form-label">드론 모델명</label>
							<div class="col-sm-7">
								<input type="text" id="d_model" name="d_model" value=""
									class="form-control">
							</div>
							<%-- 입력값 검사 효과 추가해야함 --%>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-7">
								<input type="text" id="d_status" name="d_status" value=""
									class="form-control">
							</div>
							<%-- 입력값 검사 효과 추가해야함 --%>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-7">
								<input type="text" id="d_weight" name="d_weight" value=""
									class="form-control">
							</div>
							<%-- 입력값 검사 효과 추가해야함 --%>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-7">
								<input type="text" id="d_battery" name="d_battery" value=""
									class="form-control">
							</div>
							<%-- 입력값 검사 효과 추가해야함 --%>
						</div>
